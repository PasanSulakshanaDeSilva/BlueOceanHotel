...
public class AdminSquadRoomController {
    public AnchorPane AdminQuadRoomADDContext;
    ...
    public void ModifyOnAction(ActionEvent actionEvent) {
        new Alert(Alert.AlertType.INFORMATION,"ModifySuccess!!!!").show();
    }
    ...
    private void setUi(String location) throws IOException {
        Stage stage=(Stage) AdminQuadRoomADDContext.getScene().getWindow();
